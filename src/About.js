  ...
  return (
    <React.Fragment>
      ...
      <div style={about} classNane="about">
        <h3>
          Hello there! Let me tell you a little bit about who
          <strong>I am</strong>. I'm an <strong>insighful</strong> and
          <strong>open minded</strong> individual that loves traveling, meeting
          new diverse people, and writing <strong>code</strong>. While I first
          started my career in a sales field, where I couldnt realize my
          interest for <strong>technology</strong>, I quickly discovered my
          passion for coding. I started my path in a coding bootcamp in
          ...
          designed and added new features to a planning app. With all that
